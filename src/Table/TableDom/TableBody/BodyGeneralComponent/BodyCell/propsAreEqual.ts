...
export const getProps = <T extends TableDataItem>({ rowIndex, colIndex, forceRender, defaultBgLevel }: Readonly<Props<T>>) => {
	return { colIndex, rowIndex, forceRender, defaultBgLevel };
};
