...
export const getProps = <T extends TableDataItem>({ onCellTitle, rowIndex, colIndex, align, isOverlay }: Readonly<Props<T>>) => {
	return { onCellTitle, rowIndex, colIndex, align, isOverlay };
};
