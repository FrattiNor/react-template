...
const Cron = (props: { cronExpression: string }, ref: any) => {
     ...
     * @param fun
     */
    const handleCheckboxChange = (checkedValues: string | CheckboxValueType[], type: string, fun: Function) => {
        // select双向绑定
    ...
    return (
        <div className={styles['cron-com']}>
                ...
                items={[
                    {
                        ...
                        key: '1',
                        children: (
                            <Card className={styles['card-top']}>
                                <Radio.Group
                                    onChange={(e) => {
                            ...
                            <Card className={styles['card-top']}>
                                <Radio.Group onChange={(e) => handleRadioChange(e, 'week')} value={radioValue['week']}>
                                    ...
                                    <Row>
                                        ...
                                        <Col className={styles['week-font']}>- 周</Col>
                                        <Col>
                                            <Select
                                                style={{ marginTop: 7 }}
                                                allowClear
            ...
            />
            <Card className={styles['corn-time']}>
                <Row gutter={10}>
                    <Col className={styles['titile']}>时间表达式：</Col>
                    <Col>
                        <Input placeholder="生成Cron" style={{ width: 400, marginTop: 10 }} readOnly value={cronText} />
                    </Col>
                </Row>
            </Card>
            <Card className={styles['run-time']}>
