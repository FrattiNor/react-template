...
function App() {
    return (
        <div>
            <p>
                These components are using <strong>variable</strong> sizes. This means that each element has a unique, but knowable dimension at
                render time.
            </p>
            <br />
            <br />
...
function RowVirtualizerVariable({ rows }: any) {
...
function ColumnVirtualizerVariable({ columns }: any) {
    const parentRef = React.useRef<any>();
...
function GridVirtualizerVariable({ rows, columns }: any) {
    const parentRef = React.useRef<any>();
...
function MasonryVerticalVirtualizerVariable({ rows }: any) {
    const parentRef = React.useRef<any>();
...
function MasonryHorizontalVirtualizerVariable({ rows }: any) {
    const parentRef = React.useRef<any>();
