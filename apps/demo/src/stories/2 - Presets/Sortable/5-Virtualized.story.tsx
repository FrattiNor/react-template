...
import { closestCenter, DndContext, DragOverlay, PointerSensor, KeyboardSensor, useSensor, useSensors, UniqueIdentifier } from '@dnd-kit/core';
import { arrayMove, sortableKeyboardCoordinates, SortableContext, verticalListSortingStrategy } from '@dnd-kit/sortable';

import styles from './Virtualized.module.less';
...
function Sortable({
    ...
    const [items, setItems] = useState(() => createRange<UniqueIdentifier>(itemCount, (index) => `${index + 1}`));
