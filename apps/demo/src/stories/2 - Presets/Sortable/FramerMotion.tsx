...
import { DndContext, DragEndEvent, closestCenter, PointerSensor, KeyboardSensor, useSensor, useSensors, UniqueIdentifier } from '@dnd-kit/core';
import { SortableContext, useSortable, arrayMove, rectSortingStrategy, sortableKeyboardCoordinates } from '@dnd-kit/sortable';

import { GridContainer, Wrapper } from '../../components';
import { createRange } from '../../utilities';

import styles from '../../components/Item/Item.module.less';

export function FramerMotion() {
    const [items, setItems] = useState(() => createRange<UniqueIdentifier>(16, (index) => index + 1));
