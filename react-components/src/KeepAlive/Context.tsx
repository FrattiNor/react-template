import { type FC, type PropsWithChildren, useRef, useState, createContext } from 'react';

import { type WrapperContextProps, type InnerContextProps, type CacheItem } from './type';
